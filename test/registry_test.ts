...
describe('test the function registry', () => {
  ...
  it('should register functions', () => {
    ...
    const plusIntArg1 =  <Int32Array> memoryManager.createTypedArray(Int32Array, 4)
    plusIntArg1.set([1,2,3,4])
    const plusIntArg2 =  <Int32Array> memoryManager.createTypedArray(Int32Array, 4)
    ...
    const minusIntArg1 = <Int32Array>memoryManager.createTypedArray(Int32Array, 4)
    minusIntArg1.set([1,2,3,4])
    const minusIntArg2 =  <Int32Array>memoryManager.createTypedArray(Int32Array, 4)

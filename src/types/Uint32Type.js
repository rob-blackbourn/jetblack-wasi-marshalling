...
import { uint32, void_ptr } from '../wasiLibDef'

/**
 * A type representing a 32 bit unsigned integer
 * @extends {ValueType<number>}
 */
export class Uint32Type extends ValueType<uint32> {
  /**
   ...
   */
  unmarshall (memoryManager: MemoryManager, address: void_ptr, unmarshalledIndex: number, unmarshalledArgs: Array<any>): uint32 {
    try {
